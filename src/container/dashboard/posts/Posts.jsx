...
//     }
    ...
    //     e.preventDefault();
    //
    //     // const comment = e.target.childNodes[0].childNodes[0].childNodes[0].childNodes[0];
    //     // console.log(e.target.childNodes[0].childNodes[0].childNodes[0].childNodes[0], "comment")
    //     // let validComment = false;
    //     // if (comment.value.length >= 3 && comment.value.length <= 500) {
    //     //     validComment = true;
    //     //     comment.parentElement.classList.remove("has-error")
    //     // }
    ...
    //     // } else {
    //     //     if (!validComment) {
    //     //         comment.parentElement.classList.add("has-error")
    //     //     } else {
    //     //         comment.parentElement.classList.remove("has-error")
    //     //     }
    //     // }
